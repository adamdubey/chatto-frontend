...
variable "prefix" {
  ...
  default     = "chattoapp" # Add a unique name
}

variable "project" {
  type        = string
  description = "Prefix to be added to the AWS local tags"
  default     = "chattoapp" # You can use the name unique identifier created above
}

variable "main_client_app_domain" {
  type        = string
  description = "Main client app domain"
  default     = "chatto.lol" # Your frontend domain you created a route53 zone for
}

variable "dev_client_app_domain" {
  type        = string
  description = "Dev client app domain"
  default     = "dev.chatto.lol"
}
